...
const Team_Card = ({ team, index }: { team: ITeamData, index: number }) => {
    return (
        <div className={`w-full lg:w-[90%] flex flex-col items-center mb-10 lg:mb-52  gap-5 lg:gap-10 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"} `}>
            <div className='basis-full lg:basis-1/2 '>
                <div className="md:w-[280px] lg:w-[352px] h-[180px] md:h-[280px] lg:h-[352px] bg-[#E9F3FA] flex items-center justify-center rounded-[5px]">
