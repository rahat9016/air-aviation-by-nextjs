  ...
  return (
    ...
    >
      <div className="basis-full lg:basis-[35%]">
        <div className="md:w-[280px] lg:w-[352px] rounded-[5px]">
          <img
            ...
            }  w-7/12 md:w-[180px] lg:w-[280px] rounded-[5px]`}
          />
        </div>
      </div>
      <div className="basis-full lg:basis-[65%]">
        <img src={coma} alt="km" />
        <p
          className={`text-[#424242] mt-2 text-sm font-normal  font-poppins text-left`}
        >
          {team?.comment}
        </p>
        <h2
        ...
        <h3
          className={`text-[#514C4D] text-[10px]  font-poppins lg:text-[11px]  tracking-[.15em] leading-none uppercase `}
        >
          {team?.position}
        </h3>
      </div>
