...
export function Team () {
  ...
  return (
    <Layout>
      ...
      <Common_Hero bg={bg}  />
      <div className='lg:-mt-80 container bg-no-repeat bg-center bg-contain px-mobileContainer xl:px-20 bg-white drop-shadow-md' style={{backgroundImage: `url(${vector_})`}}>
      <Team_Box/>
      <Meet_Team_Box />
      </div>
