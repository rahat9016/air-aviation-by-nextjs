...
const Blog = () => {
    ...
    return (
        <Layout>
            ...
            <Common_Hero bg={bg} title="Our Blog" desc="Learn about the essential, in’s and out’s of the logistics world" isShowSpan />
            <div className='mt-0 lg:-mt-24 xl:-mt-96 bg-white shadow-3xl container px-mobileContainer xl:px-0 mb-44'>
